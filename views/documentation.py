...
st.header("📝 Overview")
st.write("""
**Sketch-image** is an innovative tool designed to transform text prompts or sketches into visually stunning images.  
...
# How to Use Sketch-image Section
st.header("💡How to Use Sketch-image")
st.write("""
